...
Si vous vous posez la question de ce qu'est des tests automatisés, quelle est leur utilité ou encore quelle stratégie mettre en œuvre pour élaborer les tests. Alors commencez par lire l'introduction de [ce tutoriel](https://docs.djangoproject.com/fr/6.1/intro/tutorial05/).
...
Pour plus d'informations sur la configuration des tests, vous pouvez lire [ce lien](https://docs.djangoproject.com/fr/6.1/topics/testing/overview/).

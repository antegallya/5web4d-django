...
* Les différents types de champs du modèle (`DateTimeField`, `CharField`) correspondent au composant graphique d'entrée HTML approprié. Chaque type de champ possède son propre [widget](https://docs.djangoproject.com/fr/6.1/ref/forms/widgets/) dans l'interface d'administration de Django.
</Aside>
...
* [Tutoriel admin](https://docs.djangoproject.com/fr/6.1/intro/tutorial07/)
* [Doc admin](https://docs.djangoproject.com/fr/6.1/ref/contrib/admin/)
* [Action admin](https://docs.djangoproject.com/fr/6.1/ref/contrib/admin/actions/)
</Aside>

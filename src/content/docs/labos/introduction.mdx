 ...
 * Le [tutoriel Django](https://docs.djangoproject.com/fr/6.1/intro/tutorial01/)
 * La [documentation Django](https://docs.djangoproject.com/en/6.1/)
...
* **mproject/asgi.py** : un point d'entrée pour les serveurs Web compatibles aSGI pour déployer votre projet. Voir [Comment déployer avec ASGI pour plus de détails](https://docs.djangoproject.com/fr/6.1/howto/deployment/asgi/).
* **mproject/wsgi.py** : un point d'entrée pour les serveurs Web compatibles WSGI pour déployer votre projet. Voir [Comment déployer avec WSGI pour plus de détails](https://docs.djangoproject.com/fr/6.1/howto/deployment/wsgi/).
...
Vous devriez alors voir un message similaire à :

``` console showLineNumbers=false frame="none" wrap
...
September 14, 2026 - 13:37:42
Django version 6.1.1, using settings 'mproject.settings'
